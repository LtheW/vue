...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      this.$http({
        url: "/api/administer/preliminary",
        method: "post",
        headers: { "X-Requested-With": "XMLHttpRequest" },
        params: {
          workorder_number: this.workorderNumber,
          preliminary_porgram: this.textarea,
          maintainer_number: this.value,
          administrator_number: this.$store.state.administer_number,
        ...
        this.$notify({
          ...
          duration: 3000,
          type: "success",
          message: h("i", { style: "color: teal" }, "工单已提交成功"),
        });
